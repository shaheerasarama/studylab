...
include("userhandlers/getCoursesCat.php");


?>
	<section class="hero-wrap hero-wrap-2" style="background-image: url('assets/images/<?=$getNameImg1['catimg'];?>');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text align-items-end justify-content-center">
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span>Course <i class="fa fa-chevron-right"></i></span></p>
					<h1 class="mb-0 bread"><?=$getNameImg1['catname'];?></h1>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section bg-light">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="row">
						<?php while($courses=mysqli_fetch_assoc($getcoursesql)){ ?>
						<div class="col-md-6 d-flex align-items-stretch ftco-animate">
							<div class="project-wrap">
								<a href="#" class="img" style="background-image: url(assets/images/<?=$courses['img'];?>);">
									<span class="price"><?=$courses['catname'];?></span>
								</a>
								<div class="text p-4">
									<h3><a href="#"><?=$courses['name'];?></a></h3>
									<p class="advisor">Advisor <span><?=$courses['insname'];?></span></p>
									<ul class="d-flex justify-content-between">
										
										<li class="price">$<?=$courses['price'];?></li>
									</ul>
								</div>
							</div>
						</div>

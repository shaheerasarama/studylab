...
include("userhandlers/getCats.php");
include("userhandlers/getLastCo.php");
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        ...
        <p class="mb-0"><a href="courses.php" class="btn btn-primary">Our Course</a> <a href="#" class="btn btn-white">Learn More</a></p>
    </div>
</div>
</div>
</div>
      ...
      <div class="row">
         ...
         <div class="col-md-5 order-md-last">
          <div class="login-wrap p-4 p-md-5">
              ...
              <form action="userhandlers/signup.php" method="post" enctype="multipart/form-data" class="signup-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="johndoe@gmail.com" name="email" required>
                </div>
                <div class="form-group">
                    <label class="label" for="email">img</label>
             ...
             <div class="form-group">
                 ...
                 <input id="password-field" type="password" class="form-control" placeholder="Confirm Password" required name="cpassword">
             </div>
         ...
         <?php }
         ?>
         <p class="text-center">Already have an account? <a href="#signin" data-toggle="modal" data-target="#exampleModal">Sign In</a></p>
   ...
   <div class="container">
    ...
    <div class="row justify-content-center">
     ...
     <div class="col-md-3 col-lg-2">
        <a href="category.php?id=<?=$cats['id'];?>" class="course-category img d-flex align-items-center justify-content-center" style="background-image: url(assets/images/<?= $cats['img']?>);">
...
<section class="ftco-section bg-light">
   <div class="container">
    ...
    <?php while($lastco=mysqli_fetch_assoc($coursesSql)) { ?>
    <div class="col-md-4 ftco-animate">
     <div class="project-wrap">
     <a href="#" class="img" style="background-image: url(assets/images/<?=$lastco['img'];?>);">
        <span class="price"><?=$lastco['catname'];?></span>
    </a>
    <div class="text p-4">
        <h3><a href="#"><?=$lastco['name'];?></a></h3>
        <p class="advisor">Advisor <span><?=$lastco['insname'];?></span></p>
        <ul class="d-flex justify-content-between">
           <li class="price">$<?=$lastco['price'];?></li>
       </ul>
   </div>
</div>
</div>
...
<?php while($blog=mysqli_fetch_assoc($blogsSql)){ ?>
<div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('assets/images/<?=$blog['img'];?>');">
      </a>
      <div class="text d-block">
         <div class="meta">
          <p>
             <a href="#"><span class="fa fa-calendar mr-2"></span><?=date("d-m-Y", strtotime($blog['created_at']));?></a>
             <a href="#"><span class="fa fa-user mr-2"></span><?=$blog['writer'];?></a>
             <a href="#" class="meta-chat"><span class="fa fa-comment mr-2"></span> 3</a>
         </p>
     </div>
     <h3 class="heading"><a href="#"><?=$blog['hint'];?></a></h3>
     <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia...</p>
     <p><a href="blog-details.php?id=<?=$blog['id'];?>" class="btn btn-secondary py-2 px-3">Read more</a></p>
 </div>
</div>
</div>
<?php } ?>
